...
router.get('/', function(req, res) {
  res.render('index', { title: 'Houseplant App', user : req.user });
});

router.get('/register', function(req, res){
  res.render('register', {title: 'Houseplant App Registration'});
});
...
router.get('/login', function(req, res) {
  res.render('login', { title: 'Houseplant App Login', user : req.user });
});
